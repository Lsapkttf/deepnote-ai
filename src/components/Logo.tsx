  ...
  return (
    <div className={`flex items-center gap-2 ${variant === "sidebar" ? "justify-center" : ""}`}>
      <div className="relative flex items-center justify-center">
        <div className="absolute inset-0 bg-gradient-to-r from-cyan-400 to-blue-500 blur-sm opacity-70 rounded-full" />
        <div className="relative flex items-center justify-center rounded-full bg-gradient-to-r from-cyan-400 to-blue-500 p-1.5 shadow-lg">
          <Braces
